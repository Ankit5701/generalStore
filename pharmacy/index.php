...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-laugh-wink"></i> General Store</h3>
    ...
    echo " active";
                ...
                <a href="index.php?id=allPharmacist"><i id="left" class="fas fa-user"></i>All Department</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addSalesman' == $id ) {
                    ...
                    <a href="index.php?id=addSalesman"><i id="left" class="fas fa-user-plus"></i>Add Items</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'All Items' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=All Items"><i id="left" class="fas fa-user"></i>All Items</a>
            </li>
        </ul>
        <footer class="text-center"><span>General Store</span><br>©2021 All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
                            ...
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    ...
                                    <div class="col col-12">
                                        <label class="input">
                                            <i id="left" class="fas fa-user-circle"></i>
                                            <input type="text" name="lname" placeholder="type" required>
                                        </label>
                                    </div>
                                    <div class="col col-12">
                                        <label class="input">
            ...
            <div class="salesman">
                ...
                <?php if ( 'addSalesman' == $id ) {?>
                    <div class="addSalesman">
                        <div class="main__form">
                            <div class="main__form--title text-center">Add New Item</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                ...
                <?php if ( 'editSalesman' == $action ) {
                    ...
                    <div class="addManager">
                        <div class="main__form">
                            <div class="main__form--title text-center">Update Item</div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                ...
                <?php if ( 'deleteSalesman' == $action ) {
                        ...
                        header( "location:index.php?id=All Items" );
                        ob_end_flush();
                }?>
            </div>
            <!-- ---------------------- Salesman ------------------------ -->
